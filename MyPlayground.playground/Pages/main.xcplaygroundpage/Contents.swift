...
*/
print("I have $\(bankAccountNum) in my bank account")
...
*/
bankAccountNum = bankAccountNum + 100
print("I now have $\(bankAccountNum).")
...
*/
Won't work because declared with let not var 
